...
This repository provides the requisite R and Python scripts used to produce the results for two papers that were part of the [Human Impacts project](https://www.eawag.ch/en/department/siam/projects/human-impacts-on-the-community-composition-of-swiss-rivers/) at Eawag:

1. Caradima, B., Schuwirth, N., & Reichert, P. (2019). From individual to joint species distribution models: A comparison of model complexity and predictive performance. Journal of Biogeography, 46(10), 2260-2274.
2. Caradima, B., Reichert, P., & Schuwirth, N. (2020). Effects of site selection and taxonomic resolution on the inference of stream invertebrate responses to environmental conditions. Freshwater Science, 39(3), 415-432.
...
* `/outputs` stores model results and processed results (e.g., plots) that are copied manually to the respective paper folder (usually /graphics):
