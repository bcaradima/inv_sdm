...
ipak(c("tidyverse", "data.table", "car", "psych", "doParallel", "coda", "rstan", "scales", "e1071", "MASS", "crayon", "rgdal", "sf", "plotly", "ggridges", "ggpubr","ggExtra", "gridExtra", "cowplot", "svglite", "data.tree", "networkD3", "mvtnorm")) # "mgcv", "quantreg"
...
# Additional data ####
# Read experimental datasets that are either omitted from final analysis or merged into the environmental data (2017-08-18)
# idw = list()
